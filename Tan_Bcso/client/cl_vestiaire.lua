-- ==========================
-- VESTIAIRE bcso (zUI-v2 + anti CPed::SetVariation)
-- ==========================
...
-- Menu unique
local vestiaireMenu = zUI.CreateMenu("👮 VESTIAIRE BCSO", "", "Vestiaire", ConfigBcso.themes)
...
zUI.SetItems(vestiaireMenu, function()
    ...
    local clothes   = (BcsoCloak and BcsoCloak.clothes) or {}
...
exports.ox_target:addBoxZone({
    coords   = ConfigBcso.VestiaireCoords,  -- vec3
    size     = vector3(1, 1, 2),
    rotation = 0,
    debug    = false,
    options  = {
        {
            ...
            onSelect = function()
                ...
                if pdata and pdata.job and pdata.job.name == (ConfigBcso.JobRequired) then
                    OpenMenuVestiaire()
                else
