...
-- ========= Menus zUI =========
local MainMenu     = zUI.CreateMenu("CASIER JUDICIAIRE", "INTERACTION", "MENU", ConfigBcso.themes)
local CreateMenu   = zUI.CreateSubMenu(MainMenu, "CRÉATION", "", "FORMULAIRE", ConfigBcso.themes)
local ListMenu     = zUI.CreateSubMenu(MainMenu, "LISTE INDIVIDU", "", "CITIZENS", ConfigBcso.themes)
local InfoMenu     = zUI.CreateSubMenu(ListMenu, "INFO", "", "DÉTAILS", ConfigBcso.themes)
local ViewMenu     = zUI.CreateSubMenu(InfoMenu, "CASIER", "", "DOSSIER", ConfigBcso.themes)
local FilterMenu   = zUI.CreateSubMenu(ListMenu, "FILTRE A-Z", "", "CHOISIR", ConfigBcso.themes)
local MotifMenu    = zUI.CreateSubMenu(ViewMenu, "GESTION MOTIF", "", "ACTIONS", ConfigBcso.themes)
...
CreateThread(function()
    local points = (configuration and configuration.casierBcso) or {}
